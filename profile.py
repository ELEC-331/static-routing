...
node_juno.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/no-auto-routes.sh | bash'))
node_juno.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/delete-default-route.sh | bash'))
...
node_europa.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/no-auto-routes.sh | bash'))
node_europa.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/delete-default-route.sh | bash'))
...
node_thebe.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/no-auto-routes.sh | bash'))
node_thebe.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/delete-default-route.sh | bash'))
...
node_metis.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/no-auto-routes.sh | bash'))
node_metis.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/delete-default-route.sh | bash'))
...
node_router_1.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/no-auto-routes.sh | bash'))
node_router_1.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/delete-default-route.sh | bash'))
...
node_router_2.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/no-auto-routes.sh | bash'))
node_router_2.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/delete-default-route.sh | bash'))
...
node_router_3.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/no-auto-routes.sh | bash'))
node_router_3.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/delete-default-route.sh | bash'))
...
node_herse.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/no-auto-routes.sh | bash'))
node_herse.addService(pg.Execute('/bin/sh','wget -O - https://raw.githubusercontent.com/ELEC-331/tcp-ip-essentials/scripts/delete-default-route.sh | bash'))
